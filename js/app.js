 ...
 */
    ...
    (() => {
        ...
        const slider = document.querySelector(".compare__body");
        if (slider) {
            const before = document.querySelector(".compare__before-ibg");
            const beforeImage = before.querySelector("img");
            const change = document.querySelector(".compare__change");
        ...
        if (inputMasks.length) modules_flsModules.inputmask = Inputmask("+7 (999) 999 9999", {
        ...
        function initSliders() {
            if (document.querySelector(".special__slider ")) new core(".special__slider ", {
                ...
                navigation: {
                    prevEl: ".special__arrow.arrow--prev",
                    nextEl: ".special__arrow.arrow--next"
                },
                on: {}
            });
...
***************************************************************************** */
        ...
        da.init();
        function initMainBullets() {
            const watcherItems = document.querySelectorAll("[data-watch]:not([data-animate])");
            const watcherItemsLenght = watcherItems.length;
            const bulletsBlock = document.querySelector(".main-bullets");
            if (bulletsBlock && watcherItemsLenght > 0) for (let index = 0; index < watcherItemsLenght; index++) {
                let watcherItem = watcherItems[index];
                let spanChild = document.createElement("span");
                spanChild.dataset.parent = watcherItem.classList[1];
                bulletsBlock.append(spanChild);
        ...
        window.addEventListener("load", (function() {
            ...
            if (window.innerWidth < 768) {
                const detailsButton = document.querySelector(".footer__button--details");
                const details = document.querySelector(".footer__details");
                const closeDetailsButton = document.querySelector(".footer__close-details");
                if (detailsButton && details && closeDetailsButton) {
                    detailsButton.addEventListener("click", (function(e) {
                        details.classList.add("active");
                    }));
                    closeDetailsButton.addEventListener("click", (function(e) {
            ...
            if ("click" === eventType) {
                const portfolioMainItems = document.querySelectorAll(".portfolio__item-ibg");
                if (portfolioMainItems.length > 0) portfolioMainItems.forEach((portfolioMainItem => {
                    portfolioMainItem.addEventListener("click", (function(e) {
                        if (!portfolioMainItem.classList.contains("active")) {
                            e.preventDefault();
                            removeClasses(portfolioMainItems, "active");
                            portfolioMainItem.classList.add("active");
                        }
                    }));
                }));
            }
            const uploadRow = document.querySelector(".form-notification__row--upload");
            if (uploadRow) {
                const inputFile = uploadRow.querySelector("input");
                const uploadText = uploadRow.querySelector(".js-upload-text");
                inputFile.addEventListener("change", (function(e) {
                    let nmbFiles = inputFile.files.length;
                    if (nmbFiles) {
